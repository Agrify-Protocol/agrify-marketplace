...
interface SourcingToolFormProps {
  type?: string;
}

const SourcingToolForm = ({ type }: SourcingToolFormProps) => {
  ...
  return (
    <>
      <Text color="gray.600" maxW="800px">
        ...
        specifications. We&#39;ll help you source quality, traceable products
        from our network of farmers.
      </Text>
      <Box
...
export default SourcingToolForm;
